...
function mount(container: HTMLElement) {
  ...
  function render() {
    ...
    container.innerHTML = `<div class="ta-page fade-up">
      <header class="ta-hero"><div><span>Contenido de aprendizaje</span><h1>Retos y recompensas</h1><p>Administra preguntas, casos, tarjetas y premios.</p></div><button class="btn btn--primary" data-ta-new>${ico("i-plus")} Nueva actividad</button></header>
